...
public class BoardController {
	...
	public void form(HttpServletRequest req, String no, Model model) {
	...
	public String submit(HttpServletRequest req, BoardVO b) {
	...
	public void detailBoard(HttpServletRequest req, Model model, int no) {
		model.addAttribute("b", dao.detailBoard(no));
	}
	
	@GetMapping("/listBoard")
	public void listBoard(HttpServletRequest req, Model model,
